...
export default function DetailColections() {
  const Nav = [
  ...
  return (
    <div>
      <Navbar navList={Nav} />
      <div className="w-full pt-[9vh] min-h-screen font-sans justify-center items-center p-3">
        <div className="flex justify-start">
          <button onClick={() => moveTo("/colections")} className="p-1 border border-gray-200 text-gray-700 hover:text-gray-200 rounded-md">
        ...
        <div className="flex-1 pb-8">
          <h1 className="text-gray-900 text-4xl mb-4 lg:pt-7 p-3" for="nama">
